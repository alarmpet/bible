...
| 자막 계약 | ✅ `config/healing_caption_policy.json` (줄당 **12자**, min **0.65s**) |
...
| **기본 보이스** | **F5@0.95 / M5@0.85** — `config/voice_defaults.json` 고정 |
...
- narrator **F3** @ 0.78 / scripture **M2** @ 0.72  
- `config/voice_healing.yaml`
